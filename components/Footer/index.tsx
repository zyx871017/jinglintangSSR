...
const Footer = () => {
  return <div className={styles.footerContent}>
    <div className={styles.footerNav}>
      <Link className={styles.navLink} href="/info/aboutUs">关于我们</Link>
      <i className={styles.linkDivider}></i>
      <Link className={styles.navLink} href="/info/advert">广告服务</Link>
      <i className={styles.linkDivider}></i>
      <Link className={styles.navLink} href="/info/connectUs">联系我们</Link>
      <i className={styles.linkDivider}></i>
      <Link className={styles.navLink} href="/info/cooperate">业务合作</Link>
    </div>
